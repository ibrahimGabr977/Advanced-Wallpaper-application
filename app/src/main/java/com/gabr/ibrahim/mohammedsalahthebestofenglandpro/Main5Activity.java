...
public class Main5Activity extends AppCompatActivity {
    ...
    private Spinner listShapesOfImagesSpinner=null;
    private Spinner listOfZoomingOptionsSpinner=null;
    private ListShapesOfImagesClass listShapesOfImagesClass=new ListShapesOfImagesClass();
    private ListOfZoomingOptionsClass listOfZoomingOptionsClass=new ListOfZoomingOptionsClass();
    private ImageView getShapesOfImagesUp=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final OneTimeDialog oneTimeDialog=new OneTimeDialog(Main5Activity.this);
        oneTimeDialog.oneTime(getResources().getString(R.string.never),getResources().getString(R.string.guide_title),
        getResources().getString(R.string.mixing_camera),"time5");

        //Spinner Of Selecting Images And Spinner Of Zoom in out
        //=================================================================================================================================
         listShapesOfImagesSpinner=(Spinner)findViewById(R.id.spin);
        listShapesOfImagesSpinner.setOnItemSelectedListener(listShapesOfImagesClass);
        ArrayAdapter<String> aaShapes=new ArrayAdapter<>(Main5Activity.this,R.layout.support_simple_spinner_dropdown_item,getResources().getStringArray(R.array.shapes_array_5));
        aaShapes.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        listShapesOfImagesSpinner.setAdapter(aaShapes);
        listShapesOfImagesSpinner.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
                    oneTimeDialog.oneTime(getResources().getString(R.string.never),
                            ...
                            getResources().getString(R.string.shapes_guide),"time56");
                    return false;
                }else
                return false;
            }
        ...
        listOfZoomingOptionsSpinner=(Spinner)findViewById(R.id.zoom_in_out5);
        listOfZoomingOptionsSpinner.setOnItemSelectedListener(listOfZoomingOptionsClass);
        ArrayAdapter<String> aaZoom=new ArrayAdapter<>(Main5Activity.this,R.layout.support_simple_spinner_dropdown_item,getResources().getStringArray(R.array.zoom_array_5));
        aaZoom.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
        listOfZoomingOptionsSpinner.setAdapter(aaZoom);
        //==============================================================================================================================
    ...
    private String [] salah_edited;
    private void setSalah_edited(int edit_num){
        switch (edit_num){

        case 1:
            salah_edited= new String[]{
            ...
            case 2:
                salah_edited=new String[]{
                        ...
                        "https://firebasestorage.googleapis.com/v0/b/mosalah-eb905.appspot.com/o/mosalahWP%2Fsalah_wp32.png?alt=media&token=2a83e726-7f07-401b-9c75-42b6154ef93d",
                              ...
                              "https://firebasestorage.googleapis.com/v0/b/mosalah-eb905.appspot.com/o/mosalahWP%2Fsalah_wp36.png?alt=media&token=b18872d9-e6a0-4167-87de-f104faa97b50",
                        "https://firebasestorage.googleapis.com/v0/b/mosalah-eb905.appspot.com/o/mosalahWP%2Fsalah_wp37.png?alt=media&token=a5cfda15-bae7-4171-bb73-e002b8215455",
    ...
    public void switchCam(View view) {
        ...
        for (int u=0;u<sizes.size();u++){
            if (sizes.get(u).width>msize.width){
                msize=sizes.get(u);
            }
        }
        ...
        if (currentCameraId==Camera.CameraInfo.CAMERA_FACING_BACK){
            ...
            if (getResources().getConfiguration().orientation== Configuration.ORIENTATION_LANDSCAPE) {
                ...
                parameters.set("orientation","portrait");
                camera.setDisplayOrientation(90);//portraitCamera
                parameters.setRotation(0);//imageOrientation
            }
        }
    ...
    public  void flashLight(View view){
        ...
        if (Main5Activity.this.getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH)) {
            if (currentCameraId == Camera.CameraInfo.CAMERA_FACING_BACK) {
    ...
    public void takingPhoto(){
        ...
        //===================================================================
        Button rotate=(Button)findViewById(R.id.rotating);
        Button flash=(Button)findViewById(R.id.flash);
        Button takephoto=(Button)findViewById(R.id.takephoto);
        Button switchCam=(Button)findViewById(R.id.switchCam);
        listOfZoomingOptionsSpinner=(Spinner)findViewById(R.id.zoom_in_out5);
        listShapesOfImagesSpinner=(Spinner)findViewById(R.id.spin);
        //===================================================================
        ...
        listShapesOfImagesSpinner.setVisibility(View.INVISIBLE);
        listOfZoomingOptionsSpinner.setVisibility(View.INVISIBLE);
        //========================================================
         File imageFile=null;
         int fileNumber;
        final Intent openImage=new Intent(Main5Activity.this,Main6Activity.class);
        //=================================================================================

        switch (listShapesOfImagesSpinner.getSelectedItemPosition()){
            case 0:
                fileNumber=(int)(10000*Math.random());
                imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK"),"CameraImage_0"+fileNumber+".jpg");
                if (!imageFile.exists()){
                    openImage.putExtra("ImageFileNumber",fileNumber);
                    openImage.putExtra("ImageFileWord","CameraImage_0");
                    openImage.putExtra("SpinnerCurrentPosition",0);
                }else {
                    int extrafileNumber=(int)(100000*Math.random());
                    imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK"),"CameraImage_00"+extrafileNumber+".jpg");
                    openImage.putExtra("ImageFileNumber",extrafileNumber);
                    openImage.putExtra("ImageFileWord","CameraImage_00");
                    openImage.putExtra("SpinnerCurrentPosition",0);
                }
                break;
            case 2:
                fileNumber=(int)(10000*Math.random());
                imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahH"),"MoSalah_H0"+fileNumber+".jpg");
                if (!imageFile.exists()){
                    openImage.putExtra("ImageFileNumber",fileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_H0");
                    openImage.putExtra("SpinnerCurrentPosition",2);
                }else {
                    int extrafileNumber=(int)(100000*Math.random());
                    imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahH"),"MoSalah_H00"+extrafileNumber+".jpg");
                    openImage.putExtra("ImageFileNumber",extrafileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_H00");
                    openImage.putExtra("SpinnerCurrentPosition",2);
                }
                break;
            case 3:
                fileNumber=(int)(10000*Math.random());
                imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahWP"),"MoSalah_WP0"+fileNumber+".jpg");
                if (!imageFile.exists()){
                    openImage.putExtra("ImageFileNumber",fileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_WP0");
                    openImage.putExtra("SpinnerCurrentPosition" ,3);
                }else {
                    int extrafileNumber=(int)(100000*Math.random());
                    imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahWP"),"MoSalah_WP00"+extrafileNumber+".jpg");
                    openImage.putExtra("ImageFileNumber",extrafileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_WP00");
                    openImage.putExtra("SpinnerCurrentPosition",3);
                }
                break;
            case 4:
                fileNumber=(int)(10000*Math.random());
                imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahFB"),"MoSalah_FB0"+fileNumber+".jpg");
                if (!imageFile.exists()){
                    openImage.putExtra("ImageFileNumber",fileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_FB0");
                    openImage.putExtra("SpinnerCurrentPosition",4);
                }else {
                    int extrafileNumber=(int)(100000*Math.random());
                    imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahFB"),"MoSalah_FB00"+extrafileNumber+".jpg");
                    openImage.putExtra("ImageFileNumber",extrafileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_FB00");
                    openImage.putExtra("SpinnerCurrentPosition",4);
                }
                break;
            case 5:
                fileNumber=(int)(10000*Math.random());
                imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahB"),"MoSalah_B0"+fileNumber+".jpg");
                if (!imageFile.exists()){
                    openImage.putExtra("ImageFileNumber",fileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_B0");
                    openImage.putExtra("SpinnerCurrentPosition",5);
                }else {
                    int extrafileNumber=(int)(100000*Math.random());
                    imageFile=new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK/MoSalahB"),"MoSalah_B00"+extrafileNumber+".jpg");
                    openImage.putExtra("ImageFileNumber",extrafileNumber);
                    openImage.putExtra("ImageFileWord","MoSalah_B00");
                    openImage.putExtra("SpinnerCurrentPosition",5);
                }
                break;
        ...
        mhand.postDelayed(new Runnable() {
            @Override
            public void run() {
                MediaScannerConnection.scanFile(Main5Activity.this,
    ...
    private void takeScreenShot(File imageFile){
        View v1=Main5Activity.this.getWindow().getDecorView().getRootView();
    ...
    Camera.PictureCallback pictureCallback=new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            File pictureFile = new File(Environment.getExternalStoragePublicDirectory("SalahImages @GIMI79.DUK"),"Temporary_image_from_app_Camera.jpg");
            ...
            try {
                ...
                if (currentCameraId==Camera.CameraInfo.CAMERA_FACING_BACK){
                    ...
                    Bitmap bitmap1= rotate(bitmap,info.orientation,info.facing==Camera.CameraInfo.CAMERA_FACING_FRONT);
    ...
    public void takingFinalPhoto(View view) {
        Toast.makeText(Main5Activity.this,""+getResources().getString(R.string.wait_3sec)+"",Toast.LENGTH_LONG).show();
        camera.takePicture(null,null,pictureCallback);
        final ImageView bottomImage=(ImageView)findViewById(R.id.bottomimage);
        mhand=new Handler();
        mhand.postDelayed(new Runnable() {
            @Override
            public void run() {
                @SuppressLint("SdCardPath") File file=new File("/sdcard/SalahImages @GIMI79.DUK/Temporary_image_from_app_Camera.jpg");
    ...
    //Zooming Camera Methods
    //======================================================================

    @Override
    public boolean onTouchEvent(MotionEvent event) {
        if (listOfZoomingOptionsSpinner.getSelectedItemPosition()==1) {
    ...
    //resume and pause preaseving surfaceview Data
    //=============================
    ...
    SurfaceHolder.Callback surfaceCallback=new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            try {
                ...
                Toast.makeText(Main5Activity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
    ...
    public  class ListShapesOfImagesClass implements AdapterView.OnItemSelectedListener{

        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            boolean checkInternet=checkInternet();

                getShapesOfImagesUp = (ImageView) findViewById(R.id.topimage);
                listShapesOfImagesSpinner=(Spinner)findViewById(R.id.spin);
                int getImageNumber = getIntent().getIntExtra("receiveImageNumber", 0);
                RequestOptions requestOptions=new RequestOptions();
                CircularProgressDrawable circularProgressDrawable=new CircularProgressDrawable(Main5Activity.this);
                ...
                try {
                    switch (position) {
                        case 0:
                            break;
                        case 1:
                            listShapesOfImagesSpinner.setSelection(0);
                            break;
                        case 2:
                            if (checkInternet) {
                                setSalah_edited(1);
                                Glide.with(Main5Activity.this).load(salah_edited[getImageNumber]).apply(requestOptions).into(getShapesOfImagesUp);
                                listShapesOfImagesSpinner.setSelection(0);
                            } else {
                                Toast.makeText(Main5Activity.this, "" + getResources().getString(R.string.check_internet) + "", Toast.LENGTH_SHORT).show();
                                listShapesOfImagesSpinner.setSelection(0);
                            }
                            break;
                        case 3:
                    ...
                    Toast.makeText(Main5Activity.this,""+getResources().getString(R.string.try_again)+"",Toast.LENGTH_LONG).show();
                    recreate();}
    ...
    public class ListOfZoomingOptionsClass implements AdapterView.OnItemSelectedListener{
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position){
                case 0:
                    getShapesOfImagesUp.setOnTouchListener(null);
                    break;
                case 1:
                    getShapesOfImagesUp.setOnTouchListener(null);
                    break;
                case 2:
                    ...
                    getShapesOfImagesUp.setOnTouchListener(zoomingClass);
                    break;
                case 3:
                    getShapesOfImagesUp.setOnTouchListener(null);
                    getShapesOfImagesUp.setScaleType(ImageView.ScaleType.FIT_XY);
                    break;
            }
